...
function TentangKami() {
    ...
    return (
        <div className='bg-neutral-50 p-10 sm:py-10 sm:px-[40vh]'>
            <div className='mb-4'>
                <div className={`${poppins.className} text-black font-bold text-xl sm:text-3xl mb-1`}>Tentang PKDI (Profile Kemiskinan Di Indonesia)</div>
                ...
                <div>
                    <div className={`${poppins.className} text-black text-center font-bold text-xl sm:text-3xl mb-4`}>Project Members</div>
