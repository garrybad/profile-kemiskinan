...
function Berita() {
  ...
  return (
    <div className='bg-neutral-50 p-10'>
      <div className='mb-4'>
        <div className={`${poppins.className} text-black font-bold text-2xl text-center`}>Halaman Berita</div>
        <div className={`${poppins.className} font-normal text-base text-center sm:mx-40 text-black`}>Dari cerita inspiratif hingga analisis mendalam, kami menghadirkan berita terkini untuk memberi Anda gambaran yang akurat tentang tantangan dan perjuangan yang dihadapi oleh individu dan komunitas yang terpinggirkan.</div>
      </div>

      <div className='sm:mx-[40vh]'>
        <div className='grid grid-cols-12 gap-4 h-[75vh] border-solid border border-gray-300 mb-4'>
          ...
          <div className='col-span-4 pt-4 pr-4 pb-4' style={{ height: 'inherit' }}>
            <div className={`${poppins.className} text-black font-bold h-[5%]`}>TERPOPULER</div>
            <div className='h-[95%] overflow-y-scroll'>
              {dataPopularNews.map((x) => {
                return (
                  <div key={x.id} className='flex mb-2 cursor-pointer'>
                    <div className={`${poppins.className} text-gray-400 font-normal`}>{x.number}</div>
                    <div className='ml-3'>
                      <div className={`${poppins.className} text-black font-bold`}>{x.title}</div>
                      <div className={`${poppins.className} text-red-600`}>{x.area}</div>
                    </div>
                  </div>
                )
              })}
        ...
        <div className='mb-4'>
          <div className={`${poppins.className} text-black font-bold`}>Berita Utama</div>
          <div className='sm:grid grid-cols-6 gap-4'>
            {dataHeadlines.map((x) => {
              return (
                <div key={x.id} className='mb-3 sm:m-0 cursor-pointer'>
                  <div className='w-full h-[20vh] sm:h-[12vh] overflow-hidden'>
                  ...
                  <div className={`${poppins.className} text-black text-sm`}>{x.title}</div>
                </div>
              )
            })}
          </div>
        ...
        <div>
          <div className={`${poppins.className} text-black font-bold`}>Berita Lainya</div>
            ...
            {dataOtherNews.map((x) => {
              return (
                <div key={x.id} className='mb-3 sm:m-0 cursor-pointer'>
                  ...
                  <div className={`${poppins.className} text-black text-sm`}>{x.title}</div>
                  <div className={`${poppins.className} text-red-600 text-sm`}>{x.area}</div>
                </div>
              )
            })}
          </div>
